...
const ManageCars = () => {
  ...
  return (
    <div className='px-4 pt-10 w-full md:px-10'>
      <TitleOwner title="Manage Cars" subTitle="View all listed cars, update their details or remove them from booking platform" />
      <div className='max-w-3xl w-full rounded-md overflow-hidden border-borderColor border mt-6'>
