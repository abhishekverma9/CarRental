...
const CarDetails = () => {
    ...
    const { id } = useParams()
    const { cars, axios, pickupDate, returnDate, setPickupDate, setReturnDate, navigate, currency } = useAppContext()
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
                ...
                <motion.div
                    ...
                    <motion.img
                        ...
                        src={car.image} className='w-full h-auto md:max-h-100 object-cover rounded-xl shadow-md mb-6' alt="" />
                    <motion.div
                        initial={{ opacity: 0 }}
                ...
                <motion.form
                    ...
                    onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 p-6 space-y-6 text-gray-500 rounded-xl'>
                    <p className='flex items-center justify-between text-2xl text-gray-800 font-semibold'>{currency} {car.pricePerDay} <span className='text-base font-normal text-gray-400'>per day</span></p>
