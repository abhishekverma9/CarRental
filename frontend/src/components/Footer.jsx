...
const Footer = () => {
    return (
        <motion.div
            ...
            className='text-gray-500 mt-60 text-sm px-6 md:px-16 lg:px-24 xl:px-32'>
            <motion.div
                initial={{ y: 20, opacity: 0 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className='flex flex-wrap justify-between items-start pb-6 border-borderColor border-b gap-8'>
                <div>
                    <motion.img
                        initial={{ opacity: 0 }}
                ...
                className="flex flex-wrap justify-between gap-8 w-1/2">
                    ...
                    <div>
                        ...
                        <ul className='mt-3 flex flex-col gap-1.5'>
                            <li>2234 Luxury Drive</li>
                            <li>San Fransisco ,USA</li>
                            <li>+1 234 566 8674</li>
